export default {
  lineConnect: {
    ...
    running: '运行中',
    stopped: '未运行',
    androidOnly: '连线自动走棋目前仅支持 Android 平台。',
    screenCapture: '屏幕截取',
    captureRunningHint: '正在读取屏幕画面',
    captureReadyHint: '已获得截屏授权，可以开始截取',
    captureMissingHint: '需要授予屏幕录制权限才能读取对局画面',
    requestPermission: '申请截屏权限',
    startCapture: '启动截屏',
    stopCapture: '停止截屏',
    accessibility: '自动点击',
    accessibilityReadyHint: '无障碍服务已开启，可以自动落子',
    accessibilityMissingHint:
      '需要在系统设置中开启「JieqiBox 自动走棋」无障碍服务',
    openAccessibility: '打开无障碍设置',
    testTap: '测试点击',
    engine: '象棋引擎',
    engineReadyHint: '引擎已加载',
    engineMissingHint: '请先在引擎管理中加载 UCI 引擎',
    settings: '参数设置',
    mySide: '我方执子',
    autoSide: '自动判断',
    autoSideHint: '默认根据对局进程自动判断你执红还是执黑；若判断有误，可直接选红方/黑方，或在悬浮窗第二行点「自动判/执红/执黑」切换',
    autoDetecting: '正在判断走棋方…',
    detectedRed: '我方执红',
    detectedBlack: '我方执黑',
    detectWindow: '判断等待时间',
    autoPlaySwitch: '自动走棋（关闭则只分析、不落子）',
    evalNow: '当前评估',
    red: '红方',
    black: '黑方',
    clickMode: '落子方式',
    ...
    jpegQuality: '图像质量',
    chessboard: '棋盘窗口',
    chessboardHint: '点击「棋盘」会弹出一个可自由拖动、可调整大小的棋盘，实时显示识别到的局面',
    chessboardShow: '显示棋盘',
    chessboardHide: '隐藏棋盘',
    chessboardShown: '棋盘显示中',
    samples: '样本采集',
    samplesHint:
      '采集截图和识别结果，导出后用标注工具修正，就能微调模型、提升识别速度和准确率',
    samplesStart: '开始采集',
    samplesStop: '停止采集',
    samplesCount: '已采集',
    samplesUnit: '张',
    samplesPath: '保存位置',
    samplesRestartHint: '需先启动截屏服务',
    perf: '性能',
    perfMode: '本轮模式',
    perfFull: '全图定位',
    perfCrop: '棋盘裁剪',
    perfCached: '沿用上一帧（画面无变化）',
    perfChange: '画面变化',
    perfInference: '推理耗时',
    useBoardCrop: '只识别棋盘区域（更快更准）',
    skipUnchangedFrames: '画面无变化时跳过识别',
    cropMaxEdge: '裁剪输入边长',
    modelInputSize: '模型输入边长',
    relocateEvery: '重新定位间隔（轮）',
    changeThreshold: '变化判定阈值',
    overlay: '悬浮窗',
    overlayReadyHint: '切到对弈 App 后仍可操作：显示状态并可拖动',
    overlayNoPermissionHint: '需要授予「显示在其他应用上层」权限',
    overlayNoServiceHint: '请先启动截屏，悬浮窗依附于截屏服务',
    overlayShow: '显示悬浮窗',
    overlayHide: '隐藏悬浮窗',
    overlayShown: '悬浮窗显示中',
    ...
    overlayTicks: '原生心跳',
    overlayTip:
      '拖动状态条可移动位置；点击状态条可折叠/展开按钮行。按钮：新局 / 连线 / 自动·分析 / 变招 / 棋盘 / 走棋方 / 关闭。第二行「自动判」按钮点一下可在我方红/黑之间切换，判断错了随时改。',
    diagnostics: '诊断信息',
    phase: '阶段',
    passes: '轮次',
    moves: '已落子',
    ...
    missing: '未找到',
    lastFen: '最近一次识别的 FEN',
    engineFen: '引擎收到的 FEN（走子方已修正）',
    sideSourceLabel: '走棋方来源',
    sideSourceManual: '手动指定',
    sideSourceAuto: '自动判断',
    moveCheckLabel: '落子校验',
    moveCheckOk: '已生效',
    moveCheckFailed: '未生效',
    moveCheckPending: '等待确认',
    moveCheckNa: '—',
    gridFitLabel: '网格标定残差',
    gridFitUnit: '格',
    maskedLabel: '被自身悬浮窗遮挡而忽略',
    flippedLabel: '对局棋盘方向',
    flippedYes: '翻转（我方在下）',
    flippedNo: '正常（红方在下）',
    logs: '运行日志',
